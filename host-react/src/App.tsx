...
const App = () => (
  <ChakraProvider>
    <div style={{ maxWidth: "960px", margin: "auto", display: "grid", gridTemplateColumns: "1fr 3fr", gridColumnGap: "1rem"}}>
<div>
  <Search />
  <Cart />
  <DataComponent>{({filteredTaps}) => filteredTaps.map(({beverageName}) => (
